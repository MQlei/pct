<template>
  <div class="customs-regime">
    ...
    <div>
      <ul class="step-list">
        <li>VAT is paid at the destination country during the sale</li>
        <li>Intra-community transactions monitored by the Authorities until VAT payment at destination</li>
        <li>Simplified customs procedures for the importers on condition that:</li>
      </ul>
      <ul class="empty-list">
        <!-- <li>VAT is paid at the destination country during the sale</li>
        <li>Intra-community transactions monitored by the Authorities until VAT payment at destination</li>
        <li>Simplified customs procedures for the importers on condition that:</li> -->
        <li>They are AEO certified or have a representative that is AEO certified</li>
        <li>Shipment of goods to another Member State is based on a contractual agreement for performing continuous flow of imports</li>
        <!-- <li>Simplified customs procedures for the importers on condition that:</li> -->
      </ul>
    </div>
  </div>
